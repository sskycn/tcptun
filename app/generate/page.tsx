  ...
  return (
    <SiteChrome>
      <PageHero
        ...
        description="Create server.json, client.json, and client.uri locally. Native defaults to v0.2.3 Reality auto carriers; optional resumable streams and forced QUIC."
        actions={[
